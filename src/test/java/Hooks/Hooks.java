...
public class Hooks {
     ...
     /*
       ...
       Eger bizim butun testlerimiz icin herhangi bir @Before... @After... method'una ihtiyacimiz varsa
       stepdefinitions altinda herhangi bir class'a koymamiz yeterli olacaktir

       Projeler collectif calisildigindan ekipteki herkesin yerini bulabilmesi icin
